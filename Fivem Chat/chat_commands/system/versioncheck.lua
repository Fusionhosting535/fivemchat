if SETTINGS.check_updates then
    ...
    Citizen.CreateThread( function()
        ...
        PerformHttpRequest("https://raw.githubusercontent.com"..updatePath.."/master/fivemchat/version", checkVersion, "GET")
    end)
end
    ...
    if args[1] == "autoupdate" then
        ...
        PerformHttpRequest("https://raw.githubusercontent.com"..updatePath.."/master/autoupdate", function(err, responseText, headers)
            local function updateFile(fileName)
                local ok = false
                local _l = false
                PerformHttpRequest("https://raw.githubusercontent.com"..updatePath.."/master/fivemchat/" .. fileName, function(err, responseText, headers)
                    if err ~= 200 then
